...
AddEventHandler('frontier:client:weatherChanged', function(weatherId)
...
AddEventHandler('frontier:client:prepareLogout', resetHud)
...
CreateThread(function()
    ...
    local weatherState = GlobalState and GlobalState.frontierWeather
