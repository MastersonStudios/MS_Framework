...
RegisterNetEvent('ms_telegrams:server:send', function(rawNumber, rawSubject, rawBody)
    ...
    local success, err = xpcall(function()
        ...
        local recipient = MySQL.single.await([[
            ...
            INNER JOIN frontier_characters AS characters ON characters.id = accounts.character_id
        ...
        local onlineRecipient = exports.frontier_core:GetPlayerFromCharacterId(
            tonumber(recipient.character_id)
        )
...
AddEventHandler('onResourceStart', function(resourceName)
    ...
    CreateThread(function()
        ...
        Ready = true
        for _, player in pairs(exports.frontier_core:GetPlayers()) do
