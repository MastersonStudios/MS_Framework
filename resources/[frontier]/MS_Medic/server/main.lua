...
local function nearbyPatients(medicSource)
    ...
    for targetSource in pairs(exports.frontier_core:GetPlayers()) do
...
local function adminAllowed(playerSource)
    return playerSource == 0
        or IsPlayerAceAllowed(playerSource, tostring(Config.AdminAce or 'frontier.admin'))
end
...
AddEventHandler('frontier:server:playerUnloaded', clearPlayerState)
