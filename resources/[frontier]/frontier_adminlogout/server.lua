...
local function executeLogout(source, args)
    ...
    local success, err = exports.frontier_core:LogoutPlayer(target)
    ...
    print(('[Frontier Admin] %s (%d) meldete %s (%d), Charakter #%d, ab.'):format(
    ...
    TriggerEvent('frontier:server:adminLogout', source, target, characterId)
end
